const ImprovingCredit = () => {
  return (
    <>
      <hr />
      <h1 className="text-3xl">
        <strong className="xyz font-semibold">Improving Credit</strong>
      </h1>
        ...
        <div className="lg:grid lg:grid-cols-2 md:grid-cols-2 items-center">
          ...
          <div className="mb-16 lg:ml-20 ml-[0px] lg:mt-32 xl:mt-12 xl:mr-12">
            ...
            <div className="RVACS mb-10 text-start">
              <p>Get the credit you need with no annual fee</p>
            </div>
...
export default ImprovingCredit;
