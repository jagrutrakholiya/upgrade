    ...
    <header id="header" className="header mb-20 text-center  lg:text-left ">
        <div className="lg:grid lg:grid-cols-2 md:grid-cols-2">
            ...
            <div className="mb-16 xl:ml-20 lg:ml-[0px] ml-0 lg:mt-32 xl:mt-12 xl:mr-12">
                <h3 className="cFDMvZ mb-5 text-start xl:text-[3rem] lg:text-[32px] text-[32px]">Upgrade OneCard</h3>
                <div className="RVACS mb-10">
                    <ul className="list-disc">
                        <li className="mb-4 ml-6 text-start"> Get 3% cash back on everyday purchases, 2% on<br/> everything else<sup>2</sup> </li>
                        <li className="mb-4 ml-6 text-start">You control how you pay for your purchases: Pay<br/> Now with no interest, or Pay Later<sup>3</sup></li>
                        <li className="mb-4 ml-6 text-start">Extra Spending Power when you have Rewards<br/> Checking through Upgrade4<sup>4</sup></li>
